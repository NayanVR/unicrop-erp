...
class FillingController extends Controller
{
    public function index(): Response
    {
        $recipes = FillingRecipe::query()
            ->with(['outputMaterial:id,name,description,unit,stock_qty,min_stock,category', 'items.rawMaterial:id,name,description,unit,stock_qty,cost_per_unit,category,dim_l,dim_w,dim_h'])
        ...
        $materials = RawMaterial::query()
            ...
            ->orderBy('name')
            ->get(['id', 'name', 'description', 'unit', 'stock_qty', 'cost_per_unit', 'category', 'shape', 'dim_l', 'dim_w', 'dim_h']);
